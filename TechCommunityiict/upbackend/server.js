...
import teacherpostModel from './teachermodel.js'
...
const pusher = new Pusher({
    appId: "1153976",
    key: "86db340bf6b9eb74b0ee",
    secret: "6d10724e42066c8dfe71",
    cluster: "ap2",
    useTLS: true
  });
...
app.get('retrieve/teachersinfo',(req,res)=>{
    teacherpostModel.find((err,data)=>{
        if(err){
            res.status(500).send(err)
        }
        else{
