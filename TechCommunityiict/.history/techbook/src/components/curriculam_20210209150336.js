...
class Curriculam extends Component {
    constructor(props) {
       super(props) //since we are extending class Table so we have to use super in order to overrCodee Component class constructor
       this.state = { //state is by default an object
          students: [
             { Code: 1, Coursename: 'Wasif',Credit: 'wasif@Credit.com' },
             { Code: 2, Coursename: 'Ali',  Credit: 'ali@Credit.com' },
             { Code: 3, Coursename: 'Saad', Credit: 'saad@Credit.com' },
             { Code: 4, Coursename: 'Asad', Credit: 'asad@Credit.com' }
          ]
       }
    }
    ...
    render() { //Whenever our class runs, render method will be called automatically, it may have already defined in the constructor behind the scene.
       return (
          <div>
              ...
              <h2 Code="infotitle">Undergraduate program</h2>
              <div className="curriculaminfo">
              <h3>Bsc. in Software Engineering <span Code="info">(4 years)</span></h3>
